...
<form name="consulta_reporte" method="POST" action="visita_registrada.php" >
    <h3 style="text-align:center;color:#0040FF">Registrar una Visita</h3>
<a style="color:black;">Privada:<a/>
   <input type="text" id="cmbPrivadas" name = "cmbPrivadas" class="feedback-input" required>
<a style="color:black;">Observaciones:<a/>
<textarea type="text" id="observaciones" name = "observaciones" class="feedback-input" required></textarea>
    <input id="login" type="submit" value="Registrar Visita">
