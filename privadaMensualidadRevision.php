...
<title>Revisi&oacute;n Mensualidad</title>
<style>
body {
...
<form name="consulta_reporte" method="POST" action="revisionMensualidad.php" >
    <h3 style="text-align:center;color:#0040FF">Seleccione una Privada</h3>
