          ...
          <tr>
            <td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <td style="text-align:center; color: #08088A; font-family: Arial, sans-serif; font-size: 20px;">
                    <b>DATOS PARA REALIZAR EL DEPÓSITO O TRANSFERENCIA</b>
                  </td>
                  <tr><td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 14px; line-height: 20px;">
                     <b>Tipo de pago:</b>  '.$tipoPago.' <br><br> <b>Banco: </b> '.$banco.' <br><br> <b>Nombre: </b> '.$nombreCuenta.' <br><br> <b>Número de cuenta: </b> '.$numeroCuenta.' <br><br> <b>Clabe: </b> '.$clabe.' <br><br> <b>Total a pagar: </b> $'.$total.' <br><br> <b>Número de Referencia:</b> '.$numeroReferencia.' 
                    </td></tr>
 <tr>
                  <td style="padding: 20px 0 30px 0;color: #08088A; font-family: Arial, sans-serif; font-size: 14px; text-align:justify;">
                    <b>Tenga en cuenta que es muy importante que al pagar en ventanilla o al hacer transferencias, debe pagar la cantidad exacta que le solicitamos, incluyendo la referencia numérica que le proporcionamos, si paga en banco solicite al cajero que la agregue al momento de realizar el depósito. 
Esto es necesario para identificar su pago, de igual manera le pedimos que guarde su comprobante de pago, para poder aclarar cualquier duda y acreditárselo en cuenta. Solamente podemos reconocer el pago si usted agrega la referencia al momento de depositar.</b>
                  </td>
                </tr>
              </table>
...
<head>
	<title>Pagar por Depósito</title>
	<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />
</head>
<body>
<style type="text/css">
