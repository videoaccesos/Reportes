...
<form name="consulta_reporte" method="POST" action="reporte_ventasMC.php" target="_blank" >
    <h3 style="text-align:center;color:#0040FF">Reporte de Venta de Tarjetas Monte Carlo</h3>
