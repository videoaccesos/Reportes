...
<form  method="POST" action="exportarMetasExcel.php" target="_blank" >
<input type="hidden" id="cmbMesesInicial" name="cmbMesesInicial" value="<?php echo $mesInicial;?>">
<input type="hidden" id="cmbAnosInicial" name="cmbAnosInicial" value="<?php echo $anoInicial;?>">
<input type="hidden" id="cmbMesesFinal" name="cmbMesesFinal" value="<?php echo $mesFinal;?>">
<input type="hidden" id="cmbAnosFinal" name="cmbAnosFinal" value="<?php echo $anoFinal;?>">
<input type="hidden" id="cmbTipoMeta" name="cmbTipoMeta" value="<?php echo $tipoMeta;?>">
