...
RRT.fecha >= '$fechaInicial' and RRT.fecha <= '$fechaFinal' and R.privada_id = 22 ORDER BY RRTD.asignacion_id";
...
<h5 style="text-align: right; color: black;"><?php echo 'Ventas por Efectivo: $'.number_format($ventasEfectivo, 2, '.', ','); ?></h5>
...
<h5 style="text-align: right; color: black;"><?php echo 'Ventas Efectivo: $'.number_format($ventasEfectivo, 2, '.', ','); ?></h5>
<h5 style="text-align: right; color: black;"><?php echo 'Gastos Efectivo: $'.number_format($gastosEfectivo, 2, '.', ','); ?></h5>
<b><h4 style="text-align: right; color: black;"><?php $totalEfectivo= $ventasEfectivo-$gastosEfectivo; echo 'Liquidación: $'.number_format($totalEfectivo, 2, '.', ','); ?></h4></b><br>
