...
<img src="images/videoaccesos.png">
			...
			<br>
<h4 style="color:white;width: 60%; text-align: justify;">Para concluir su compra seleccione la tienda de conveniencia donde desea realizar su pago y presione el botón "Finalizar Compra", posteriormente verifique en su bandeja de entrada el correo que le enviamos con la información que nos proporcionó, también se le enviará un correo de "Notificación PagoFácil" con las instrucciones para pagar, si no encuentra busque en su bandeja de correos no deseados o spam. Recuerde que su correo registrado es a donde le llegarán las notificaciones de acceso a su residencia.</h4>

<center><form name="msform" id="msform" method="post"  action="finalizar_efectivo.php">
...
<select style="width: 250px" name="tienda" id="tienda">
  <option value="1">OXXO</option>
  <option value="2">Seven Eleven</option>
  <option value="3">Extra</option>
  <option value="4">Chedraui</option>
  <option value="5">Farmacia Benavides</option>
  <option value="6">Farmacia Esquiver</option>
</select>

<input style="margin-left: 50px" type="submit" name="finalizar" class="finalizar" value="Finalizar Compra" ></input>
</form></center>
</body>
</html>