...
<form name="consulta_reporte" method="POST" action="agregar_mensualidades.php" target="_blank" >
...
<!--<a style="color:black;">Meses que desea agregar:<a/>
<br><br>
<div style="width:100%;text-align:center;margin-left:5px;" >
<input type="checkbox" name="chkEnero" id="chkEnero" checked> Enero
<input type="checkbox" name="chkFebrero" id="chkFebrero" checked> Febrero   
<input type="checkbox" name="chkMarzo" id="chkMarzo" checked> Marzo <br>
<input type="checkbox" name="chkAbril" id="chkAbril" checked> Abril
<input type="checkbox" name="chkMayo" id="chkMayo" checked> Mayo   
<input type="checkbox" name="chkJunio" id="chkJunio" checked> Junio <br>
<input type="checkbox" name="chkJulio" id="chkJulio" checked> Julio
<input type="checkbox" name="chkAgosto" id="chkAgosto" checked> Agosto   
<input type="checkbox" name="chkSeptiembre" id="chkSeptiembre" checked> Septiembre <br>
<input type="checkbox" name="chkOctubre" id="chkOctubre" checked> Octubre
<input type="checkbox" name="chkNoviembre" id="chkNoviembre" checked> Noviembre   
<input type="checkbox" name="chkDiciembre" id="chkDiciembre" checked> Diciembre <br>
</div><br>-->

    <input id="login" type="submit" value="Agregar Mensualidades">
